        ...
        <div class="color-container sm:w-9/12 mt-10 p-5 sm:p-10 rounded-2xl border-[var(--contrast)] border-[6px]">
            ...
            <div class="lg:grid grid-cols-2 my-6 text-center">
                <div class="flex flex-col items-center sm:px-5 sm:pt-5 mt-4 sm:mt-0">
                    <h1
                        class="text-lg sm:text-2xl font-bold text-[var(--contrast)] px-4 py-2 bg-[var(--neutral)] rounded-2xl">
                        Lawan Kata/Antonim</h1>
                    <h1 class="text-md sm:text-xl font-bold text-[var(--contrast)] lg:px-4 mt-4">Antonim adalah kata
                        yang memiliki makna berlawanan dengan kata lainnya.</h1>
                    <h1 class="text-md sm:text-xl font-bold text-[var(--contrast)] lg:px-4 mt-8">Contoh: antonim dari
                        <b>JUAL</b> adalah <b>BELI</b></h1>
                </div>
                <div class="flex flex-col items-center sm:px-5 sm:pt-5 mt-8 sm:mt-0">
                    <h1
                        class="text-lg sm:text-2xl font-bold text-[var(--contrast)] px-4 py-2 bg-[var(--neutral)] rounded-2xl">
                        Persamaan Kata/Sinonim</h1>
                    <h1 class="text-md sm:text-xl font-bold text-[var(--contrast)] lg:px-4 mt-4">Sinonim adalah kata
                        yang memiliki makna yang sama dengan kata lainnya.</h1>
                    <h1 class="text-md sm:text-xl font-bold text-[var(--contrast)] lg:px-4 mt-8">Contoh: sinonim dari
                        <b>LUAS</b> adalah <b>BESAR</b></h1>
                </div>
            </div>
        </div>
