...
@section('body')
<section class="min-h-screen min-w-screen pb-10 relative">
    <div class="w-full flex items-center flex-col">
        <div class="title-container py-10 flex items-center justify-center">
            ...
            <div class="judul" data-aos="zoom-in" data-aos-easing="ease-out-cubic">
                <div class="word">
                    <span class="letter"
                ...
                <div class="word" data-aos="zoom-in" data-aos-easing="ease-out-cubic">
                    <span class="letter"
    ...
    <!-- <div class="hiasan w-12/12 absolute">
        <img class="kupu" style="width: 55px; rotate: 30deg; left: 0; bottom: 40vh;" src="{{ asset('asset/bg/kupu2.png') }}" alt="">
    </div> -->
</section>
@endsection