...
@section('body')
    <section class="min-h-screen min-w-screen py-10">
        <div class="w-full flex items-center flex-col">
            ...
            <div class="color-container w-9/12 mt-10 py-5 p-2 sm:p-10 rounded-2xl border-[var(--contrast)] border-[6px]">
            ...
            <div class="number-container w-9/12 mt-10 py-5 p-2 sm:p-10 rounded-2xl border-[var(--contrast)] border-[6px]">
                <h1 class="text-3xl sm:text-4xl font-extrabold drop-shadow-2xl text-[var(--contrast)] text-center">
                    Mengenal Angka</h1>
